...
class Robot {
	...
	void makeOmelet(int eggNum, int butterNum) {
		System.out.println(Math.min(eggNum / 2, butterNum / 5) + "人分のオムレツを作成しました。\n");
	}
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		if (robot.makeEggDishes(flourNum, sugarNum, eggNum, butterNum) != null) {
			System.out.println(robot.makeEggDishes(flourNum, sugarNum, eggNum, butterNum) + "が出来ました。\n");
		} else {
